...
return new class extends Migration
{
    ...
    {
        Schema::create('sablage_externes', function (Blueprint $table) {
            $table->string('code_Sablage_Externe')->primary();
     $table->string('ref_production');
     $table->foreign('ref_production')->references('production_code')->on('productions')->restrictOnDelete();
     $table->date('date_Sablage_Externe');
    ...
    {
        Schema::dropIfExists('sablage_externes');
    }
};
